...
public class ExecutionEnvUtil {
    ...
    public static ParameterTool createParamterTool(final String[] args) throws Exception{
    ...
    public static  final ParameterTool PARAMETER_TOOL =createParamterTool();

    public static  ParameterTool createParamterTool(){
           try{
